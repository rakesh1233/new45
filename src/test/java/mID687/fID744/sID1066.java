...
public class AlertsScr1 extends  AllActions {
...
Set<Cookie> cc;
	...
	catch(Exception e)
	{
        ...
        try
        {
            val=actions.GetAllDropDownOptionLength(new AlertNLP(driver).multii);
        ...
        try
        {
            cc=actions.GetAllCookiesDetails();
