...
package mID663.fID715;
import pom.ComplileEMR;
import java.io.File;
...
public class errorCompile extends  AllActions {
	...
	catch(Exception e)
	{
        ...
        try
        {
            actions.EnterData(new ComplileEMR(driver).authUser3,"authUser3Value");
        ...
        try
        {
            actions.EnterData(new ComplileEMR(driver).clearPass4,"clearPass4Value");
        ...
        try
        {
            actions.Click(new ComplileEMR(driver).buttonobj6);
