...
public class SL050 extends  AllActions {
	...
	catch(Exception e)
	{
        ...
        try
        {
            actions.EnterData(new SL050(driver).UnameEMR,"UnameEMRValue");
        ...
        try
        {
            actions.EnterData(new SL050(driver).PassEMR,"PassEMRValue");
        ...
        try
        {
            actions.Click(new SL050(driver).LoginEMR);
