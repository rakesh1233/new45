...
public class TE042 extends  AllActions {
	...
	catch(Exception e)
	{
        ...
        try
        {
            actions.EnterData(new ZZZZZ(driver).txtUsername6,"txt555555");
        ...
        try
        {
            actions.EnterData(new ZZZZZ(driver).txtPassword7,"txtPassword7Value");
        ...
        try
        {
            actions.Click(new ZZZZZ(driver).Submit8);
