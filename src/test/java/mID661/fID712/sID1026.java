...
package mID661.fID712;
import pom.OrengeAutocorrection;
import java.io.File;
...
public class AutoCorrectScript extends  AllActions {
	...
	catch(Exception e)
	{
        ...
        try
        {
            actions.EnterData(new OrengeAutocorrection(driver).txtUsername6,"Admin");
        ...
        try
        {
            actions.EnterData(new OrengeAutocorrection(driver).txtPassword7,"admin123");
        ...
        try
        {
            actions.Click(new OrengeAutocorrection(driver).Submit8);
