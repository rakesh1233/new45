...
public class EMRAutoCorrection extends  AllActions {
	...
	catch(Exception e)
	{
        ...
        try
        {
            actions.EnterData(new EMRAutoCorrection(driver).UserN,"YJX-admin-19");
        ...
        try
        {
            actions.EnterData(new EMRAutoCorrection(driver).PassW,"Adminadmin2123");
        ...
        try
        {
            actions.Click(new EMRAutoCorrection(driver).LoginB);
