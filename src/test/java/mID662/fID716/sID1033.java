...
public class Safariclosed extends  AllActions {
	...
	catch(Exception e)
	{
        ...
        try
        {
            actions.EnterData(new SafariTC(driver).txtUsername6,"txtUsername6Value");
        ...
        try
        {
            actions.EnterData(new SafariTC(driver).txtPassword7,"txtPassword7Value");
        ...
        try
        {
            actions.Click(new SafariTC(driver).Submit8);
