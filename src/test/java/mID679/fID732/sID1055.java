...
public class alertTest extends  AllActions {
	...
	catch(Exception e)
	{
        ...
        try
        {
            actions.EnterApplicationURL("https://demoqa.com/alerts");
        ...
        try
        {
            actions.Click(new alerts(driver).clickAlert);
