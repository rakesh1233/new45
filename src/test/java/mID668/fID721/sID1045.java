...
public class comapre3rd extends  AllActions {
	...
	catch(Exception e)
	{
        ...
        try
        {
            actions.EnterData(new Compare33(driver).txtUsername6,"txtUsername6Value");
        ...
        try
        {
            actions.EnterData(new Compare33(driver).txtPassword7,"txtPassword7Value");
