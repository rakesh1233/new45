...
public class ManageTCUp extends  AllActions {
	...
	catch(Exception e)
	{
        ...
        try
        {
            actions.EnterData(new CompareOBJ(driver).txtUsername6,"txtUsername6Value");
        ...
        try
        {
            actions.EnterData(new CompareOBJ(driver).txtPassword7,"txtPassword7Value");
