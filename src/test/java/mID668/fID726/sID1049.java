...
package mID668.fID726;
import pom.ManageTestUp;
import java.io.File;
...
public class orenge extends  AllActions {
	...
	catch(Exception e)
	{
        ...
        try
        {
            actions.EnterData(new ManageTestUp(driver).txtUsername6,"txtUsername6Value");
        ...
        try
        {
            actions.EnterData(new ManageTestUp(driver).txtPassword7,"txtPassword7Value");
        ...
        try
        {
            actions.Click(new ManageTestUp(driver).Submit15);
