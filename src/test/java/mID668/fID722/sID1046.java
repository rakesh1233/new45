...
public class compare22 extends  AllActions {
	...
	catch(Exception e)
	{
        ...
        try
        {
            actions.EnterData(new TheInter(driver).username1,"username1Value");
        ...
        try
        {
            actions.Click(new TheInter(driver).loginbut);
