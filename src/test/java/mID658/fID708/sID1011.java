...
public class SQLLinks extends  AllActions {
	...
	catch(Exception e)
	{
        ...
        try
        {
            actions.EnterApplicationURL("https://www.tutorialspoint.com/sql/sql-overview.htm");
        ...
        try
        {
            actions.Click(new SQLPoints(driver).Database);
