...
package mID658.fID708;
import pom.PracticeAuto;
import java.io.File;
...
public class PracticeAuto extends  AllActions {
	...
	catch(Exception e)
	{
        ...
        try
        {
            actions.EnterApplicationURL("http://automationpractice.com/index.php");
        ...
        try
        {
            actions.Click(new PracticeAuto(driver).ItemImg);
        ...
        try
        {
            actions.Click(new PracticeAuto(driver).Except);
