...
package mID665.fID718;
import pom.SonicWorld;
import java.io.File;
...
public class worldWatch extends  AllActions {
	...
	catch(Exception e)
	{
        ...
        try
        {
            actions.EnterData(new SonicWorld(driver).txtUsername6,"txtUsername6Value");
        ...
        try
        {
            actions.Click(new SonicWorld(driver).txtPassword7);
        ...
        try
        {
            actions.EnterData(new SonicWorld(driver).Submit8,"Submit8Value");
