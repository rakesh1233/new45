...
public class TestEngineerAuto extends  AllActions {
	...
	catch(Exception e)
	{
        ...
        try
        {
            actions.EnterApplicationURL("https://github.com/Chidamabar05/TestMAnager");
        ...
        try
        {
            actions.Click(new AutoEngg(driver).securityLabs);
