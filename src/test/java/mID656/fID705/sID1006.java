...
package mID656.fID705;
import reuseablePackage.reuseFunction.orengeLoginClass;
import pom.OrengeAfLogin;
import pom.OrengeLogout;
import java.io.File;
...
public class Performace extends  AllActions {
	...
	catch(Exception e)
	{
        ...
        try
        {
            new orengeLoginClass(driver).orengeLogin();
        ...
        try
        {
            actions.Click(new OrengeAfLogin(driver).Performance);
        ...
        try
        {
            actions.Click(new OrengeAfLogin(driver).EmpTracker);
        ...
        try
        {
            actions.Click(new OrengeLogout(driver).WelcomeExcel);
        ...
        try
        {
            actions.Click(new OrengeLogout(driver).Logout);
