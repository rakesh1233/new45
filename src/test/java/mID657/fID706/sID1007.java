...
package mID657.fID706;
import pom.JavaOracel;
import java.io.File;
...
public class JTestcases extends  AllActions {
	...
	catch(Exception e)
	{
        ...
        try
        {
            actions.EnterApplicationURL("https://www.java.com/en/");
        ...
        try
        {
            actions.Click(new JavaOracel(driver).Privacy);
