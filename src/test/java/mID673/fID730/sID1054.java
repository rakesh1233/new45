...
public class orenge extends  AllActions {
	...
	catch(Exception e)
	{
        ...
        try
        {
            actions.EnterApplicationURL("https://docs.google.com/spreadsheets/d/14ZGW1UIU1-KC8mGrOnyRZTSBnXIfm_wIqA4LnKaDcSA/edit#gid=1679720830");
